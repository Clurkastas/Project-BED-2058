...
continentdata <- temp %>%
  ...
  summarise(health = mean(health),
            ...
            education = mean(educ),
            safety = mean(secu),
            environment = mean(envir),
            `life quality` = mean(meta))
...
such as environment, health, economics, education and safety. After we divided it for 5 (number of variables) and arranged it.

What is the result of it?
According to our data, the best country to live in is Norway with 1.81 points, the second place Ireland takes and the
