...
This probably means that even if the considered variables are different and even if we use a different method to aggregate them, the core of the two works is the same.
