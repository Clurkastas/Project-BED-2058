...
The second essential variable for us was economics as the economic situatio of a country is crucial for one's own situation.
...
As a source of data we considered different sources. These were gapminder, World Development Indicators (WDI), OECD, Quandl and eurostat.
...
Also overall, their data quality was worse.
...
All five variables for the individual topics were weighted equally to create the meta variable of life quality. 
The top and bottom ten countries are depicted in the following chart.
...
In general, it is possible to see that almost the 10 best and worst countries confirm their position in all the three graphs.
...
As you can see in this graph, the overall life quality per person is highest in Oceania. 
...
However, the relationship is not significant. Therefore, data suggests that life quality is independent from country size. 
...
OECD cam to the same conclussion within their [Better Life Index Project](http://www.oecdbetterlifeindex.org/). 
They did use more categories and different variables, but answered the question in the same way, which is a nice validation of the result.
