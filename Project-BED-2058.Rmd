...
ggsave("TopBottom10.png", height = 7 , width = 12)
```
...
# ggsave("Health.png", height = 7 , width = 12) #for you, Kirill
...
ggsave("economy.png", height = 7 , width = 12)
ep2 
...
ggsave("safety1.png", height = 7 , width = 12)
```
...
ggsave("safety2.png", height = 7 , width = 12)
```
...
ggsave("safety3.png", height = 7 , width = 12)
```
...
ggsave("environment.png", height = 7 , width = 12)
```
