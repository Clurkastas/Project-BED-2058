...
All five variables for the individual topics were weighted equally to create the meta variable of life quality. With this particular method, we were able to have a general point of view.
...
The next graph shows the world map with colors for each country.
...
As it is possible to observe in this graph, the overall life quality per person presents the highest value in Oceania. 
...
This graph shows the result that comes out putting the three variables together in one called "ECON".
...
In fact, they have presented an high differentiation within their own territory.
