...
To find out which variables we could use properly, we sorted chosen variables from the gapminder dataset and the World Development Indicators (WDI) into our five overarching topics. Variables were selected on the basis of their quality, e.g. amount of missings and great enough variance. After sorting, we conducted a confirmatory factor analysis for each topic. Unfit variables were sorted out and are depicted in red in the table below. Factor scores were used for further analysis.
